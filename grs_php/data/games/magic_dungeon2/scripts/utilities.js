...
var DIR_UP = new Direction(0, new Point(0, 1), "Up");
var DIR_RIGHT = new Direction(1, new Point(1, 0), "Right");
var DIR_DOWN = new Direction(2, new Point(0, -1), "Down");
var DIR_LEFT = new Direction(3, new Point(-1, 0), "Left");
