  ...
  <div class="row">
    {{#each games}}
      <div class="col s4" style="vertical-align: top">
        <div style="padding: 10px; border: 2px solid #000000; background: {{this.background}}; cursor: pointer"
          onclick="window.location.assign('/games/{{this.path}}')">
        <div style="display: inline-block; width: 128px; height: 128px;">
          <img style="width: 128px; height: 128px; border: 2px solid {{this.foreground}};" src="/static/games/thumbnails/{{this.path}}.png" />
        </div>
